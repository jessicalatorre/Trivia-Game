    ...
    function writeQuestion() {
        for (i = 0; i < questions.length; i++) {
            ...
            for (var j = 0; j < answerChoices[i].length; j++) {
                ...
                radButton.attr('name', 'answerChoice' + i);//set the attribute of type to radio
                ...
                questionDiv.append(radButton); //radio button dot is made
                questionDiv.append(answerChoices[i][j]); //then the ..
        ...
        // $(".btn-primary").click(writeQuestion,function(){
